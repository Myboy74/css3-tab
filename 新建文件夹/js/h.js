(function () {
    var h = {},
        mt = {},
        c = {
            id: "49411f7bde52035653f2e2b70a0bb6a5",
            dm: ["1905.com", "m1905.com", "m.1905.com", "vip.1905.com", "big.1905.com", "passport.1905.com", "pay.m1905.com"],
    ...
    mt.cookie.set = function (a, b, d) {
        ...
        document.cookie = a + "=" + b + (d.domain ? "; domain=" + d.domain : "") + (d.path ? "; path=" + d.path : "") + (f ? "; expires=" + f.toGMTString() : "") + (d.mb ? "; secure" : "")
    };
    ...
    mt.h.bb = function (a) {
        ...
        if (!a) return b;
        var d = mt.h.sa(a).documentElement;
    ...
    (function () {
        var a = mt.event;
        mt.f = {};
        mt.f.Ga = /msie (\d+\.\d+)/i.test(navigator.userAgent);
        mt.f.Ea = /msie (\d+\.\d+)/i.test(navigator.userAgent) ? document.documentMode || +RegExp.$1 : r;
        ...
        mt.f.Ka = (window.screen.width || 0) + "x" + (window.screen.height || 0);
    ...
    h.p = {
        ...
        Wa: 1,
        A: 2147483647,
        fa: "kb cc cf ci ck cl cm cp cu cw ds vl ep et fl ja ln lo lt rnd si su v cv lv api sn ct u tt".split(" ")
    };
    (function () {
        var a = {
            r: {},
    ...
    (function () {
        ...
        var d = mt.lang,
            ...
            e = {
                ...
                qa: function () {
                    if (0 < e.z.length)
                        for (var a = 0, d = e.z.length; a < d; a++) e.S(e.z[a]);
                    e.z = t
                },
                S: function (a) {
                    var b = a[0];
                ...
                _trackPageview: function (a) {
                    if (1 < a.length && a[1].charAt && "/" === a[1].charAt(0)) {
                        ...
                        e.aa || (h.b.a.su = document.location.href);
                        h.b.j();
                        h.b.a.u = b;
                        h.b.a.su = d
                    }
                ...
                _setReferrerOverride: function (a) {
                    1 <
                        a.length && (h.b.a.su = a[1].charAt && "/" === a[1].charAt(0) ? n.protocol + "//" + window.location.host + a[1] : a[1], e.aa = s)
                },
                ...
                _setAutoTracking: function (a) {
                    if (1 < a.length && (a = a[1], u === a || s === a)) h.b.$ = a
                }
            };
        e.init();
        h.ka = e;
    ...
    (function () {
        function a() {
            "undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = s, this.a = {}, this.$ = this.Z = s, this.P = u, this.init())
        }
        var b = mt.url,
            d = mt.ea,
            f = mt.U,
        ...
        a.prototype = {
            ...
            wa: function () {
                if (!document.referrer) return k.m -
                    k.s > c.vdur ? 1 : 4;
                var a = u;
            ...
            Oa: function () {
                var a, b, d, e,
                    f;
                k.s = this.getData("Hm_lpvt_" + c.id) || 0;
                ...
                if (0 === c.nv &&
                    this.C(document.location.href) && ("" === document.referrer || this.C(document.referrer))) a = 0, b = 4;
                this.a.nv = a;
                this.a.st = b;
                this.a.cc = d;
                this.a.lt = e;
            ...
            Pa: function () {
                ...
                this.a.cm = b.i(a, k.Ba) || "";
                this.a.cp = b.i(a, k.Ca) || b.i(a, k.Ta) || "";
                this.a.cw = b.i(a, k.Aa) || b.i(a, k.Va) || "";
                this.a.ci = b.i(a, k.ya) || b.i(a, k.Sa) || "";
                this.a.cf = b.i(a, k.Da) || b.i(a, k.Ua) || "";
                this.a.cu = b.i(a, k.za) || b.i(a, k.Ra) || ""
            },
            init: function () {
                try {
                    this.Pa(), 0 === this.a.nv ? this.Ma() : this.T(".*"), h.b = this, this.la(), w.B("pv-b"), this.La()
                } catch (a) {
                    var b = [];
                    b.push("si=" + c.id);
            ...
            la: function () {
                var a = document.location.hash.substring(1),
                    d = RegExp(c.id),
                    e = b.L(document.referrer) === k.ia ? 1 : 0,
                    f = b.i(a, "jn"),
    ...
    (function () {
        var a = mt.f,
            ...
            d = mt.event,
            f = mt.l;
        if ("undefined" !== typeof h.b && (c.med || (!a.Ga || 7 < a.Ea) && c.cvcc)) {
    ...
    (function () {
        ...
        if ("undefined" !== typeof h.b && b.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
            var g = {
                ga: function () {
                    for (var b = c.cvcf.length, f, p = 0; p < b; p++)(f = a.X(decodeURIComponent(c.cvcf[p]))) && d.c(f, "click", g.oa())
                },
                oa: function () {
                    return function () {
                        h.b.a.et = 86;
